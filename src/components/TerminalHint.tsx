...
export default function TerminalHint({
  ...
  return (
    <button
      ...
      className="-my-3 inline-block min-h-11 min-w-11 cursor-pointer content-center px-1 font-mono text-[11px] tracking-[0.14em] text-noise uppercase transition-colors duration-150 hover:text-signal"
    >
      {label}
    </button>
  );
